...
<qgis autoRefreshMode="Disabled" autoRefreshTime="0" hasScaleBasedVisibilityFlag="0" labelsEnabled="1" layerType="Vector" maxScale="0" minScale="100000000" readOnly="0" simplifyAlgorithm="0" simplifyDrawingHints="1" simplifyDrawingTol="1" simplifyLocal="1" simplifyMaxScale="1" styleCategories="AllStyleCategories" symbologyReferenceScale="-1" version="4.0.1-Norrköping">
  ...
  <renderer-v2 enableorderby="0" forceraster="0" referencescale="-1" symbollevels="0" type="RuleRenderer">
    <rules key="{ed46e539-d35b-49bf-825d-9d1a1c12c167}">
      <rule filter="&quot;context_type&quot;  =  'cut'&#xa;  AND&#xa;&quot;context&quot; =&#xa; regexp_substr( @layer_name, 'BA-[0-9]{1,3}|B[0-9]{1,3}|[0-9]{1,3}')" key="{c7d2c185-2e5f-440a-b017-fafe7c616f28}" label="Cuts" symbol="0"/>
      <rule filter="&quot;context_type&quot; IN ('deposit' , '')&#xa;  AND&#xa;&quot;context&quot; =&#xa; regexp_substr( @layer_name, 'BA-[0-9]{1,3}|B[0-9]{1,3}|[0-9]{1,3}')" key="{600203a9-3a21-4e13-8481-ae5a21fd4c13}" label="Deposits" symbol="1"/>
      <rule filter="&quot;context_type&quot;  =  'structure' &#xa;  AND&#xa;&quot;context&quot; =&#xa; regexp_substr( @layer_name, 'BA-[0-9]{1,3}|B[0-9]{1,3}|[0-9]{1,3}')" key="{ee434f0a-5ecd-49f7-a07a-455854431d35}" label="Structures" symbol="2"/>
      <rule filter="&quot;context_type&quot;  =  'bedrock' &#xa;  AND&#xa;&quot;context&quot; =&#xa; regexp_substr( @layer_name, 'BA-[0-9]{1,3}|B[0-9]{1,3}|[0-9]{1,3}')" key="{ad84b260-1736-47c1-ab15-1c23f48eaec1}" label="Bedrock" symbol="3"/>
      <rule checkstate="0" filter="ELSE" key="{17698f07-976c-4869-a9b7-73838c0b55c9}" symbol="4"/>
    </rules>
    <symbols>
      <symbol alpha="1" clip_to_extent="1" force_rhr="0" frame_rate="10" is_animated="0" name="0" type="fill">
        ...
        <layer class="SimpleFill" enabled="1" id="{b2138b3f-e9cc-48ad-a52a-f738a6ae5edc}" locked="0" pass="0">
          <Option type="Map">
            <Option name="border_width_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"/>
            ...
            <Option name="offset_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"/>
            <Option name="offset_unit" type="QString" value="MM"/>
            <Option name="outline_color" type="QString" value="196,60,57,255,rgb:0.7686275,0.2352941,0.2235294,1"/>
      ...
      <symbol alpha="1" clip_to_extent="1" force_rhr="0" frame_rate="10" is_animated="0" name="1" type="fill">
        ...
        <layer class="SimpleFill" enabled="1" id="{53517abf-9842-4b13-8675-90fae81f19fe}" locked="0" pass="0">
          <Option type="Map">
            <Option name="border_width_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"/>
            <Option name="color" type="QString" value="220,220,220,255,hsv:0,0,0.86309605836868286,1"/>
            <Option name="joinstyle" type="QString" value="bevel"/>
            <Option name="offset" type="QString" value="0,0"/>
            <Option name="offset_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"/>
            <Option name="offset_unit" type="QString" value="MM"/>
      ...
      <symbol alpha="1" clip_to_extent="1" force_rhr="0" frame_rate="10" is_animated="0" name="2" type="fill">
        ...
        <layer class="SimpleFill" enabled="1" id="{eb0b6bfb-5f50-4e38-9d4b-d219ae27311f}" locked="0" pass="0">
          <Option type="Map">
            <Option name="border_width_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"/>
            <Option name="color" type="QString" value="197,197,197,255,hsv:0,0,0.77381551265716553,1"/>
            <Option name="joinstyle" type="QString" value="bevel"/>
            <Option name="offset" type="QString" value="0,0"/>
            <Option name="offset_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"/>
            <Option name="offset_unit" type="QString" value="MM"/>
      ...
      <symbol alpha="1" clip_to_extent="1" force_rhr="0" frame_rate="10" is_animated="0" name="3" type="fill">
        ...
        <layer class="SimpleFill" enabled="1" id="{eb0b6bfb-5f50-4e38-9d4b-d219ae27311f}" locked="0" pass="0">
          <Option type="Map">
            <Option name="border_width_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"/>
            <Option name="color" type="QString" value="220,220,220,255,rgb:0.8627451,0.8627451,0.8627451,1"/>
            <Option name="joinstyle" type="QString" value="bevel"/>
            <Option name="offset" type="QString" value="0,0"/>
            <Option name="offset_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"/>
            <Option name="offset_unit" type="QString" value="MM"/>
        ...
        <layer class="PointPatternFill" enabled="1" id="{8eb0ea3e-5db1-4fcd-9a4f-ea2c743a2979}" locked="0" pass="0">
          <Option type="Map">
            ...
            <Option name="outline_width_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"/>
            <Option name="outline_width_unit" type="QString" value="MM"/>
            <Option name="random_deviation_x" type="QString" value="2"/>
            ...
            <Option name="random_deviation_y" type="QString" value="4"/>
            ...
            <Option name="seed" type="QString" value="54390965"/>
          </Option>
          <data_defined_properties>
            <Option type="Map">
              <Option name="name" type="QString" value=""/>
          ...
          <symbol alpha="1" clip_to_extent="1" force_rhr="0" frame_rate="10" is_animated="0" name="@3@1" type="marker">
            ...
            <layer class="SimpleMarker" enabled="1" id="{271f5868-218f-4778-b55f-d51a24938a74}" locked="0" pass="0">
              <Option type="Map">
                <Option name="angle" type="QString" value="0"/>
                <Option name="cap_style" type="QString" value="square"/>
      ...
      <symbol alpha="1" clip_to_extent="1" force_rhr="0" frame_rate="10" is_animated="0" name="4" type="fill">
        ...
        <layer class="SimpleFill" enabled="1" id="{4c7dec50-0f8a-47ef-bae0-f3189990d694}" locked="0" pass="0">
          <Option type="Map">
            <Option name="border_width_map_unit_scale" type="QString" value="3x:0,0,0,0,0,0"/>
        ...
        <config>
          <Option type="Map">
            <Option name="map" type="List">
              <Option type="Map">
                <Option name="deposit" type="QString" value="deposit"/>
              </Option>
              <Option type="Map">
                <Option name="cut" type="QString" value="cut"/>
              </Option>
              <Option type="Map">
                <Option name="structure" type="QString" value="structure"/>
              </Option>
              <Option type="Map">
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="&quot;context&quot;" sortOrder="1">
    <columns>
